...
<body>
	<div>
        ...
        <label for='dateC'> Date du contact : </label>
                        ...
                        <input type="email" placeholder="monmail@site.org" name="email" required>
                        ...
                        <input type="text" placeholder="Entrez le sujet de votre mail" name="sujet" required>
                        <label for='Contenu'> Contenu : </label>
                        <textarea placeholder="Tapez ici la demande de votre mail" name="contenu"></textarea>
                        <span class="error" id="errorcont" aria-live="polite"><?php echo $contErr;?></span><br><br>
